  ...
  return (
    <div className='w-screen flex flex-col items-center p-40 bg-blanco text-negro'>
          ...
          <form action="" id="formulario de productos" className='flex'>
            ...
            <div className='mt-10'>
              <input className='bg-green-300 rounded-[25px] px-5 py-2' type="button" value="Aceptar" />
              <input className='bg-green-300 rounded-[25px] px-5 py-2' type="button" value="Cancelar" />
            </div>
    </div>
  )
}
